...
This document provides a comprehensive reference for all Nodus REST and WebSocket APIs, explaining how each endpoint integrates with the frontend UX and the underlying agent system.
...
The Nodus API is a FastAPI-based backend that powers a multi-agent AI platform for professional services. The architecture consists of:

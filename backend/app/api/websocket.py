...
class ConnectionManager:
    ...
    async def send_tool_call(
        ...
        """Send tool.call event for showing tool usage."""
        await self.broadcast(conversation_id, "tool.call", {
            "agent_name": agent,
            "tool_name": tool_name,
    ...
    async def send_tool_result(
        ...
        """Send tool.result event for showing tool output."""
        await self.broadcast(conversation_id, "tool.result", {
            "agent_name": agent,
            "tool_name": tool_name,

#!/usr/bin/env python3
"""
Nodus Demo Test and Cleanup Script
...
async def test_azure_openai() -> bool:
    ...
    try:
        ...
        response = await llm.complete(
            prompt="Say 'Hello, Nodus!' in exactly those words.",
        ...
        # Test embeddings
        start = time.time()
        embedding = await llm.embed("Test embedding for Nodus demo")
        elapsed = time.time() - start
...
async def quick_status():
    ...
    print_header("Nodus Demo Status Check")

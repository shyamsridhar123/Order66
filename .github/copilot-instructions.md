# Nodus - AI Coding Agent Instructions

## Project Overview

**Nodus** is a multi-agent AI platform for professional services, demonstrating coordinated AI agents that mirror a consulting firm's operating model.
